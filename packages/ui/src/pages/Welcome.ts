    ...
    >
      <div style="flex: 1">
        <section class="section pt-4 has-text-centered">
          ...
          <h1 class="title is-6 mb-0 has-text-white">Welcome to</h1>
          <img src=${logotype} width="340" />
        </section>

        <section class="section pt-4">
          <p>
            AlgoSigner is your new way sign and create transactions on the
            Algorand network.
          </p>
          <p class="mt-4">
            It is also a hot wallet for Algorand currency, and can manage assets
            on the network.
          </p>
        </section>
      </div>
