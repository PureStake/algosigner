...
const Authorize: FunctionalComponent = (props) => {
  ...
  useEffect(() => {
    ...
    if (
      store.savedRequest &&
      store.savedRequest.body.method == JsonRpcMethod.Authorization
    ) {
      ...
      <div style="flex: 1">
        ...
        <section class="section py-0">
          ...
          <ul class="pl-5 mt-5" style="list-style: disc;">
            <li>
              <b>Read</b> the list of <b>accounts</b> in this wallet per
              supported ledger.
            </li>
            <li class="mt-4">
              <b>Send you requests for transactions.</b> You will have the
              chance to review all transactions and will need to sign each with
