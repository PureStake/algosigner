...
const TxAppl: FunctionalComponent = (props: any) => {
  ...
  return html`
    <div class="box" style="overflow-wrap: break-word;">
      ...
      <p><strong>Application Id:</strong> <span>${tx['application-transaction']['application-id']}</span></p>
      <p><strong>On Completion:</strong> <span>${tx['application-transaction']['on-completion']}</span></p>
