  ...
  return html`
    ...
    >
      ...
      <div class="px-3" style="flex: 1;">
        ...
        />
        <p class="mb-4">
          After making this screen, you will be provided with the public key and
          mnemonic for your new account.
        </p>
        <p class="mb-4">It will only be shown once.</p>
        <p class="mb-4">
          Make sure you have a secure location to store these keys. They are the
          only way to access your account in the future.
        </p>
        <b
