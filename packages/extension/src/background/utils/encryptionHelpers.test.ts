...
test('Validate blob object component conversion to hex', () => {
  const blob = new Blob(
    ...
    EncryptionHelpers.hexStringToUint8Array(
      'd316599689403d40d78404a7255a0e2a16c4d5bdaf52bcf44d9aec7f4ba31b55'
    ),
    5000000,
    1
  );
...
test('Validate Uint8Array to hex conversion', () => {
  const hexValue = EncryptionHelpers.bufferToHex(new Uint8Array([1, 2, 3, 4, 5]));
