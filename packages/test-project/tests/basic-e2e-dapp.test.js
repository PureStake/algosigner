...
describe('Wallet Setup', () => {
  ...
  const amount = Math.floor(Math.random() * 10 + 0.1); // txn size, modify multiplier for bulk
...
describe('Basic dApp Setup and GET Tests', () => {
  ...
  test('Get an Asset', async () => {
    const ownerAccount =
      'Q2SLSQTBMVJYVT2AANUAXY4A5G7A3Y6L2M6L3WIXKNYBTMMQFGUOQGKSRQ';
    ...
    await appPage.waitForTimeout(2000);
    console.log(
      `TestNet asset info: ${getAnAsset['asset']['params']['unit-name']}`
    );
...
describe('dApp Asset Txn Tests', () => {
  const getSignedBlob = null;
  const assetTxId = null;
  ...
  test('Asset Create Tx', async () => {
    console.log(
      `Starting Asset Create for ${testAccountAddress} using ${JSON.stringify(
        getParams
      )}`
    );
  ...
  test('Post Asset Create Blob', async () => {
    ...
    getTxId = await postTransaction(assetCreateBlob, appPage);
  ...
  test('Asset Opt-in Tx', async () => {
    ...
    if ('message' in localSignedBlob) {
      ...
      console.log(
        `Exiting Asset Create/Sign Opt-in Tx: ${assetOptInBlob.txID} for ${assetIndex}`
      );
    }
  });
  ...
  test('Post Asset Transfer Blob', async () => {
    console.log(
      `Entering Post Asset Transfer Tx for ${assetTransferBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Verify Asset Transfer Tx', async () => {
    console.log(
      `Starting Verify Asset Tx: ${assetTransferBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Asset Clawback Tx', async () => {
    console.log(
      `Entering Asset Clawback Tx ${assetIndex} for ${transferAmount}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Post Asset Clawback Blob', async () => {
    console.log(
      `Entering Post Asset Clawback Tx for ${assetClawBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Verify Asset Clawback Tx', async () => {
    console.log(
      `Starting Verify Asset Clawback Tx: ${assetClawBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Asset Freeze Tx', async () => {
    ...
    if ('message' in localSignedBlob) {
      ...
      console.log(
        `Exiting Asset Freeze Create/Sign Tx ${localSignedBlob.txID} for ${assetIndex}`
      );
    }
  });
  ...
  test('Post Asset Freeze Blob', async () => {
    console.log(
      `Entering Post Asset Freeze Tx for ${assetFrzBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Verify Asset Freeze Tx', async () => {
    console.log(
      `Starting Verify Asset Freeze Tx: ${assetFrzBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Post Asset Un-Freeze Blob', async () => {
    console.log(
      `Entering Post Asset Un-Freeze Tx for ${assetUnFrzBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Verify Asset Un-Freeze Tx', async () => {
    console.log(
      `Starting Verify Un-Asset Un-Freeze Tx: ${assetUnFrzBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Asset Close-to Tx', async () => {
    ...
    if ('message' in getTxId) {
      ...
      console.log(
        `Exiting Asset Transfer Close-to Tx ${localSignedBlob.txID} for ${assetIndex}`
      );
    }
  });
  ...
  test('Post Asset Close-to Blob', async () => {
    console.log(
      `Entering Post Asset Close-to Tx for ${assetCloseBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Verify Asset Close-to Tx', async () => {
    console.log(
      `Starting Verify Asset Close-to Tx: ${assetCloseBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Asset Destroy Tx', async () => {
    console.log(
      `Entering Asset Destroy Tx ${assetIndex} for ${transferAmount}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
    ...
    if ('message' in localSignedBlob) {
      ...
      console.log(
        `Exiting Asset Destroy Create/Sign Tx ${localSignedBlob.txID} for ${assetIndex}`
      );
    }
  });
  ...
  test('Post Asset Destroy Blob', async () => {
    console.log(
      `Entering Post Asset Destroy Tx for ${assetDestroyBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
  ...
  test('Verify Asset Destroy Tx', async () => {
    console.log(
      `Starting Verify Asset Destroy Tx: ${assetDestroyBlob.txID} for ${assetIndex}`
    );
    await appPage.waitForTimeout(shortApiTimeout);
