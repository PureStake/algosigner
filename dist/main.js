    ...
    <div class=${"modal "+(c?"is-active":"")}>
      ...
      <div class="modal-content" style="padding: 0 15px;">
        <${ue}
          error=${w}
          loading=${m}
          nextStep=${e=>Ee(void 0,void 0,void 0,(function*(){_(!0),k(""),O("");const t={ledger:i,address:A.address,amount:1e6*+p,note:v,to:d,passphrase:e};G(V.SignSendTransaction,t,(function(e){if(console.log("SENT",e),"error"in e)switch(_(!1),e.error){case"Login Failed":k("Wrong passphrase");break;default:O(e.error),l(!1)}else console.log("setting txid",e.txId),l(!1),b(e.txId)}))}))} />
      </div>
      <button class="modal-close is-large" aria-label="close" onClick=${()=>l(!1)} />
    </div>
